...
namespace HelloMarioFramework
{
    public class TitleScreen : MonoBehaviour
    {
        ...
        [SerializeField] private string customLevelSceneName;
        ...
        private IEnumerator ChangeScene()
        {
            selected = true;
            yield return new WaitForSeconds(1.5f);
            LoadingScreen.scene = !string.IsNullOrEmpty(customLevelSceneName) ? customLevelSceneName : hubScene.ScenePath;
